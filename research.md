...
<h3 style="text-align:center;"> Planning of manipulation primitives </h3>
 ...
 A key challenge in locomotion and manipulation is designing motions that react intelligently to unexpected perturbations and changes in the environment. I am developing a small set of closed-loop manipulation primitives that can be sequenced to achieve complex manipulations.
...
Enforcing a sequence of planned motions can be challenging under model uncertainty and with limited sensing. I use switchable adhesion to control contact-state (e.g. sticking versus sliding) during locomotion and manipulation.
...
Advances in manufacturing have enabled the development of legged microrobots capable of operation at multiple stride frequencies using multi-degree-of-freedom leg trajectories. I used  proprioceptive sensing and control to track desired leg tajectories and enable effective locomotion at a wide range of stride frequencies.  
...
Advances in laminate-based manufacturing have enabled the development of highly articulated microrobots. I develop models of their joints (compliant flexures) and actuators (piezoelectric bimorphs) to predict the behavior and improve the design of these robots.
...
**Science 2018: The milliDelta. ** This improved understanding of piezoelectric bending bimorph actuators and compliant flexures was used to inform the design of the milliDelta. This robot can operate with precision down to ∼5μm in a 7 mm<sup>3</sup> workspace and can follow periodic trajectories at frequencies up to 75 Hz. The milliDelta can be used for applications such as vibration cancellation in microsurgery and microassembly, or micromanipulation. **[[Publications]](https://robotics.sciencemag.org/content/3/14/eaar3018), [[Video]](https://www.youtube.com/watch?v=rHUnqYDgUFY)**
